...
const Newsletter = () => {
  return (
    <div className='flex items-center justify-center'>
            <div className='bg-[#F4F9FF] w-[350px] ss:w-[500px] md:w-fit relative rounded-[50px] md:rounded-[75px] py-4 ss:py-10 md:py-[70px] px-[40px] flex gap-0 ss:gap-2 md:gap-10 items-center justify-center md:flex-row flex-col shadow-lg '>
